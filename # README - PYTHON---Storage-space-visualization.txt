...
create a PYTHON app for storage space visualization
ChatGPT said:
Here's a Python app that visualizes storage space usage using Matplotlib and Tkinter. The app scans a selected directory and displays a pie chart showing the space occupied by different subfolders.

Storage Space Viz

Answer in chat instead
This Python app allows users to select a folder and generates a pie chart showing the storage space used by its subfolders. Let me know if you need any modifications! 🚀📊
